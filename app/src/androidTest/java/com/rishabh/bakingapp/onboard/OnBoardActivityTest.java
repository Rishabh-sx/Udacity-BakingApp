...
public class OnBoardActivityTest {
    ...
    @Test
    public void onBoardActivityTest2() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_recipe), withText("Cheesecake"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.rv),
                                        3),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tv_recipe), withText("Yellow Cake"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.rv),
                                        2),
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.tv_recipe), withText("Nutella Pie"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.rv),
                                        0),
